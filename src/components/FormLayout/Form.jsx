...
export default function Forms() {
  return (
    <form>
      <div className="space-y-12 p-12 lg:pl-40 lg:pr-40">
      ...
      <div className="mt-6 flex items-center justify-end gap-x-6 mb-4 lg:mr-40 lg:mb-12 p-20">
